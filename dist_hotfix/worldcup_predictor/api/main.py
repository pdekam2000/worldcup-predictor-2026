...
from worldcup_predictor.api.routes.accuracy import router as accuracy_router
...
from worldcup_predictor.api.routes.billing import legacy_router as billing_legacy_router
from worldcup_predictor.api.routes.billing import router as billing_router
...
app.include_router(billing_legacy_router, prefix="/api")
