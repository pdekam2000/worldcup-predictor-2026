    ...
    def create_checkout_session(
        ...
        *,
        ...
        if not readiness.checkout_enabled:
            msg = readiness.message or CHECKOUT_INACTIVE_MSG
            code = "stripe_price_invalid" if msg == PLAN_UNAVAILABLE_MSG else "checkout_disabled"
            raise CheckoutValidationError(msg, code=code, status_code=503)
