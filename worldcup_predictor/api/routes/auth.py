...
def _register_message(
    *,
    ...
    if not verification_required and email_delivery_status == "verification_disabled":
...
def auth_config() -> dict:
    """Public auth flags for frontend (no secrets)."""
...
def login(body: LoginRequest, request: Request) -> dict:
    ...
    if code == "email_verification_required" and email_verification_required():
