...
def main() -> int:
    ...
    if result.success:
        ...
        record("confidence_not_stale_3", float(fresh.get("confidence") or 0) > 15, f"conf={fresh.get('confidence')}")
        ...
        record("served_confidence_fresh", served is not None and float(served.get("confidence") or 0) > 15)
