"""Phase 34B — invalidate stale/placeholder stored predictions safely."""
...
def _has_placeholder_flag(payload: dict[str, Any]) -> bool:
    ...
    if generated_by == "background_daily" and payload.get("prediction_engine_version") != PREDICTION_ENGINE_VERSION:
        return True
    return False
