...
_MARKET_DEFS: tuple[tuple[str, str, str], ...] = (
    ...
    ("First Goal Team", "first_goal_team", "market_fg_status"),
)
...
def build_performance_summary(
    *,
    ...
    if summary:
        ...
        fg = summary.get("first_goal_team")
        if isinstance(fg, dict) and fg.get("total"):
            markets.append(_market_block_from_summary_key("First Goal Team", fg))
