...
|---|---|
| Local | `3b1293f` |
| GitHub (`release/football-strength-shadow-infra-20260730T151432Z`) | `3b1293f` |
| Production `/opt/worldcup-predictor` | `3b1293f` |

Tip message: *Fix research preview odds loader for CanonicalOddsSnapshot fields.*
