#!/usr/bin/env python3
"""USA-BELGIUM-CONTROLLED-PREDICTION-1 — Odds + prediction workflow capture."""
...
FIXTURE_ID = 1570715
ARTIFACT = ROOT / "artifacts" / "usa_belgium_controlled_prediction_1" / "workflow.json"
...
def main() -> int:
    result = {
        "phase": "USA-BELGIUM-CONTROLLED-PREDICTION-1",
